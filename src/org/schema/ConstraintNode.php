 ...
 * with properties which appear to describe a single entity, but are being used in a situation where they serve a more abstract purpose.
 *
...
class ConstraintNode extends Intangible
{
     ...
     */
    public null|string|array|Property $constraintProperty ;
