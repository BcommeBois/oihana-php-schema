...
class Action extends Thing
{
     ...
     * @var Person|Organization|string|array|null
     */
    public null|Person|Organization|array|string $agent ;
     ...
     * @var null|Thing|array|string
     */
    public null|Thing|array|string $error ;
     ...
     * @var null|Thing|array|string
     */
    public null|Thing|array|string $object ;
     ...
     * @var string|EntryPoint|array|null
     */
    public null|string|array|EntryPoint $target ;
}
