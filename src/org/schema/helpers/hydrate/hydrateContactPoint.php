...
function hydrateContactPoint( mixed $properties = null ): mixed
{
    ...
    // constructor threw : `ContactPoint` takes an array or an object, never a string.
    return array_map( fn( $property ) => is_scalar( $property ) ? $property : new ContactPoint( $property ) , $properties ) ;
}
