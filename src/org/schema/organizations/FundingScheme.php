 ...
 * - Swiss Priority Programmes (SPPs);
 * - EU Framework 7 (FP7);
 * - Horizon 2020;
 * - the NIH-R01 Grant Program;
 * - Wellcome institutional strategic support fund.
 *
 * For large scale public sector funding, the management and administration of grant awards is often handled by other,
 * dedicated, organizations - FundingAgencys such as ERC, REA, ...
 *
