...
/**
 * IPTC "Digital Source" codes for use with the digitalSourceType property, providing information
 ...
 * or might be considered mutually incompatible by upstream maintainers of the definitions.
 *
 * See the IPTC documentation for detailed definitions of all terms.
 *
 * @see https://schema.org/CompositeSyntheticDigitalSource
 */
class CompositeSyntheticDigitalSource extends MediaEnumeration
{
