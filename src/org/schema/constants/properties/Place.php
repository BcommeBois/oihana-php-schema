...
trait Place
{
    ...
    const string AMENITY_FEATURE                     = 'amenityFeature' ;
    const string BRANCH_CODE                         = 'branchCode' ;
    const string CONTAINED_IN_PLACE                  = 'containedInPlace' ;
    const string CONTAINS_PLACE                      = 'containsPlace' ;
    ...
    const string PROHIBITIONS                        = 'prohibitions' ;
    const string PUBLIC_ACCESS                       = 'publicAccess' ;
    const string REMAINING_ATTENDEE                  = 'remainingAttendee' ;
    const string REVIEW                              = 'review' ;
    const string SERVICE                             = 'service' ;
    const string SLOGAN                              = 'slogan' ;
    const string SMOKING_ALLOWED                     = 'smokingAllowed' ;
    const string SPECIAL_OPENING_HOURS_SPECIFICATION = 'specialOpeningHoursSpecification' ;
    const string TELEPHONE                           = 'telephone' ;
    const string TOUR_BOOKING_PAGE                   = 'tourBookingPage' ;
