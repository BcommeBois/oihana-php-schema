...
trait GeospatialGeometryTrait
{
     ...
     * @var array|string|GeospatialGeometry|Place|null
     */
    public null|string|array|GeospatialGeometry|Place $geoContains ;
     ...
     * @var array|string|GeospatialGeometry|Place|null
     */
    public null|string|array|GeospatialGeometry|Place $geoCoveredBy ;
     ...
     * @var array|string|GeospatialGeometry|Place|null
     */
    public null|string|array|GeospatialGeometry|Place $geoCovers ;
     ...
     * @var array|string|GeospatialGeometry|Place|null
     */
    public null|string|array|GeospatialGeometry|Place $geoCrosses ;
     ...
     * @var array|string|GeospatialGeometry|Place|null
     */
    public null|string|array|GeospatialGeometry|Place $geoDisjoint ;

    /**
     * Represents spatial relations in which two geometries (or the places they represent) are topologically equal, as defined in DE-9IM. "Two geometries are topologically equal if their interiors intersect and no part of the interior or boundary of one geometry intersects the exterior of the other" (a symmetric relationship).
     * @var array|string|GeospatialGeometry|Place|null
     */
    public null|string|array|GeospatialGeometry|Place $geoEquals ;
     ...
     * @var array|string|GeospatialGeometry|Place|null
     */
    public null|string|array|GeospatialGeometry|Place $geoIntersects ;
     ...
     * @var array|string|GeospatialGeometry|Place|null
     */
    public null|string|array|GeospatialGeometry|Place $geoOverlaps ;
     ...
     * @var array|string|GeospatialGeometry|Place|null
     */
    public null|string|array|GeospatialGeometry|Place $geoTouches ;
     ...
     * @var array|string|GeospatialGeometry|Place|null
     */
    public null|string|array|GeospatialGeometry|Place $geoWithin ;
}
