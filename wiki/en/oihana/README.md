...
| [Commercial management](commercial-management.md) | *(business guide)* | The business-level read of the commercial cycle: the quote → order → delivery → invoice → payment → statement flow, what distinguishes each document, the mirror seller/buyer viewpoints, financial tracking. The conceptual companion to the *Business documents* reference. |
