...
- [Appointments](appointments.md) — the meetings a salesperson holds. 🔑 **Availability** does not live here: it sits on the **account** (`User::$hoursAvailable`, see [Authentication](auth.md)), because a person gaining a second role keeps one diary.
