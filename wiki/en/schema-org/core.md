...
- **Reservations & tickets** — `Reservation` (base type for the [reservations guide](reservations.md)), `Ticket`, `Seat`,
...
| Reservations & tickets | `Reservation` (base — sub-types under [reservations](reservations.md)), `Ticket`, `Seat`   |
