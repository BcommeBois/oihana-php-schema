...
- learning material and credentials (`HowTo`, `Certification`, `Credential`, `EducationalOccupationalCredential`),
...
| Credentials            | `Certification`, `Credential`, `EducationalOccupationalCredential`                              |
