...
- [Rendez-vous](appointments.md) — les rencontres qu'un commercial tient. 🔑 Les **disponibilités** ne vivent pas ici : elles sont sur le **compte** (`User::$hoursAvailable`, voir [Authentification](auth.md)), parce qu'une personne qui gagne un second rôle garde un seul agenda.
