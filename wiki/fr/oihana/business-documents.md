...
- **la somme se vérifie à l'œil** : `537,6 + 1 193,775 = 1 731,375`, le `weight` du bon ;
- **le poids d'une ligne est celui de ce qui est parti** : la première a livré 84 des 120 m² commandés, son poids est celui des 84.
