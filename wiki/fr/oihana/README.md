...
| [Documents commerciaux](business-documents.md) | `…\business\documents` | Objets de valeur transverses du cycle devis/commande/facture : `TaxDetail`, `Adjustment`, `EcoFeeRule`/`AppliedEcoFee`, `DocumentTotals`, `BusinessDocumentLine`, `PaymentSchedule`/`PaymentInstallment`. |
