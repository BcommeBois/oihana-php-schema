...
| [Gestion commerciale](gestion-commerciale.md) | *(guide métier)* | Lecture métier du cycle commercial : le flux devis → commande → livraison → facture → paiement → relevé, ce qui distingue chaque document, les points de vue vendeur/acheteur en miroir, le suivi financier. Le compagnon conceptuel de la référence *Documents commerciaux*. |
