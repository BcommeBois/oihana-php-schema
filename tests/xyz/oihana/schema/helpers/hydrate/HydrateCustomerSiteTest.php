...
final class HydrateCustomerSiteTest extends TestCase
{
    ...
    public function testHydratesAnIndexedArrayAndFiltersTheRest(): void
    {
        ...
        $this->assertSame( [ 'site-ref-42' ] , hydrateCustomerSite( [ 'site-ref-42' ] ) ) ;
        $this->assertNull( hydrateCustomerSite( [ null ] ) ) ;
    }
    ...
    {
        $bare = hydrateCustomerSite( [ 'site-ref-42' , 'site-ref-42' ] ) ;

        $this->assertSame( [ 'site-ref-42' , 'site-ref-42' ] , $bare ) ;

        $mixed = hydrateCustomerSite( [ 'site-ref-42' , [ 'name' => 'Head office' ] ] ) ;

        $this->assertSame( [ 0 , 1 ] , array_keys( $mixed ) ) ;
        $this->assertSame( 'site-ref-42' , $mixed[ 0 ] ) ;
        $this->assertInstanceOf( CustomerSite::class , $mixed[ 1 ] ) ;
    }
}
